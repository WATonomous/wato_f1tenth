...
static const _Filtered_type_support_symbol_names_t _Filtered_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sample_msgs, msg, Filtered)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sample_msgs, msg, Filtered)),
  }
};
...
{
  return &::sample_msgs::msg::rosidl_typesupport_cpp::Filtered_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, sample_msgs, msg, Filtered)() {
  return get_message_type_support_handle<sample_msgs::msg::Filtered>();
}
