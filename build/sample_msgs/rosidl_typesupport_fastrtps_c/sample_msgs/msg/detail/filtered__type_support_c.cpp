...
bool cdr_serialize_sample_msgs__msg__Metadata(
  const sample_msgs__msg__Metadata * ros_message,
  eprosima::fastcdr::Cdr & cdr);

bool cdr_deserialize_sample_msgs__msg__Metadata(
  eprosima::fastcdr::Cdr & cdr,
  sample_msgs__msg__Metadata * ros_message);
...
bool cdr_serialize_key_sample_msgs__msg__Metadata(
  const sample_msgs__msg__Metadata * ros_message,
  eprosima::fastcdr::Cdr & cdr);

size_t get_serialized_size_key_sample_msgs__msg__Metadata(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_key_sample_msgs__msg__Metadata(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: metadata
  {
    cdr_serialize_sample_msgs__msg__Metadata(
  ...
  sample_msgs__msg__Filtered * ros_message)
{
  ...
  // Field name: metadata
  {
    cdr_deserialize_sample_msgs__msg__Metadata(cdr, &ros_message->metadata);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sample_msgs__msg__Filtered;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: metadata
  {
    cdr_serialize_key_sample_msgs__msg__Metadata(
      &ros_message->metadata, cdr);
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: metadata
  current_alignment += get_serialized_size_key_sample_msgs__msg__Metadata(
    &(ros_message->metadata), current_alignment);
  ...
  size_t current_alignment)
{
  ...
  // Field name: metadata
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_sample_msgs__msg__Metadata(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const sample_msgs__msg__Filtered * ros_message = static_cast<const sample_msgs__msg__Filtered *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_sample_msgs__msg__Filtered(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  sample_msgs__msg__Filtered * ros_message = static_cast<sample_msgs__msg__Filtered *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_sample_msgs__msg__Filtered(cdr, ros_message);
}
