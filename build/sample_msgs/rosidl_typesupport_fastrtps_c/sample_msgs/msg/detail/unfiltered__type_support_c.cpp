  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sample_msgs__msg__Unfiltered;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const sample_msgs__msg__Unfiltered * ros_message = static_cast<const sample_msgs__msg__Unfiltered *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_sample_msgs__msg__Unfiltered(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  sample_msgs__msg__Unfiltered * ros_message = static_cast<sample_msgs__msg__Unfiltered *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_sample_msgs__msg__Unfiltered(cdr, ros_message);
}
