  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sample_msgs__msg__Metadata;
    is_plain =
      (
      offsetof(DataType, creation_date) +
      last_member_size
      ) == ret_val;
  }
  return ret_val;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const sample_msgs__msg__Metadata * ros_message = static_cast<const sample_msgs__msg__Metadata *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_sample_msgs__msg__Metadata(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  sample_msgs__msg__Metadata * ros_message = static_cast<sample_msgs__msg__Metadata *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_sample_msgs__msg__Metadata(cdr, ros_message);
}
