...
#define NODE_MAIN_LOGGER_NAME "udp_receiver_node_exe"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libudp_driver_nodes.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<drivers::udp_driver::UdpReceiverNode>";
